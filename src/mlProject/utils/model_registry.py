        ...
        for v in registry.get("versions", []):
            if v.get("id") == version_id:
                ...
                if not versioned_path.exists():
                    ...
                    return False
                # Versioned artifacts and their stable alias belong to the same
                # registry directory.  Keeping this relative to the registered
                # artifact also makes custom registries and test deployments work.
